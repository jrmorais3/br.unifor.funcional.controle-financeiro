defmodule Financial.TransactionsTest do
  use Financial.DataCase

  alias Financial.Transactions

  describe "transactions" do
    alias Financial.Transactions.Transaction

    import Financial.TransactionsFixtures
